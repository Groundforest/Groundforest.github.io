...
export const GradE =  styled.div`
    ...
    background: -moz-linear-gradient(rgba(202,66,70,1) 16.666%, rgba(225,101,65,1) 16.666%, rgba(225,101,65,1) 33.333%, rgba(241,143,67,1) 33.333%, rgba(241,143,67,1) 50%, rgba(139,152,98,1) 50%, rgba(139,152,98,1) 66.666%, rgba(71,96,152,1) 66.666%, rgba(71,96,152,1) 83.333%, rgba(167,72,155,1) 83.333%);
    background: -webkit-linear-gradient(rgba(202,66,70,1) 16.666%, rgba(225,101,65,1) 16.666%, rgba(225,101,65,1) 33.333%, rgba(241,143,67,1) 33.333%, rgba(241,143,67,1) 50%, rgba(139,152,98,1) 50%, rgba(139,152,98,1) 66.666%, rgba(71,96,152,1) 66.666%, rgba(71,96,152,1) 83.333%, rgba(167,72,155,1) 83.333%);
    background: linear-gradient(rgba(202,66,70,1) 16.666%, rgba(225,101,65,1) 16.666%, rgba(225,101,65,1) 33.333%, rgba(241,143,67,1) 33.333%, rgba(241,143,67,1) 50%, rgba(139,152,98,1) 50%, rgba(139,152,98,1) 66.666%, rgba(71,96,152,1) 66.666%, rgba(71,96,152,1) 83.333%, rgba(167,72,155,1) 83.333%);
